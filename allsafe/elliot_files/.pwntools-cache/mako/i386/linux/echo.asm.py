...
_magic_number = 10
_modified_time = 1473634653.707323
_enable_loop = True
_template_filename = '/usr/local/lib/python2.7/dist-packages/pwnlib/shellcraft/templates/i386/linux/echo.asm'
_template_uri = 'i386/linux/echo.asm'
...
def render_body(context,string,sock='ebp',**pageargs):
    ...
    try:
        ...
        __M_writer(u'\n')
        __M_writer(unicode(i386.linux.syscall('SYS_write', sock, 'esp', len(string))))
        __M_writer(u'\n')
        return ''
    finally:
...
"""
__M_BEGIN_METADATA
{"source_encoding": "ascii", "line_map": {"32": 2, "33": 3, "34": 4, "35": 6, "36": 6, "37": 7, "38": 7, "44": 38, "16": 4, "17": 3, "23": 1, "27": 1, "28": 2}, "uri": "i386/linux/echo.asm", "filename": "/usr/local/lib/python2.7/dist-packages/pwnlib/shellcraft/templates/i386/linux/echo.asm"}
__M_END_METADATA
"""
